...
const docTemplate = `{
    ...
    "paths": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.PaginatedVariableResponse"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.CreateVariableRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/variables/{variableSetName}/{variableName}": {
            "get": {
        ...
        "/api/v1/variablesets": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.PaginatedVariableSetResponse"
                                        }
                                    }
                                }
                            ]
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Created variable set",
                        "name": "variableSet",
                        "in": "body",
                        "required": true,
                        "schema": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/entity.VariableSet"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/v1/variablesets/matched": {
            "get": {
                ...
                "operationId": "listVariableSetsByLabels",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Label selectors to match variable sets",
                        "name": "selector",
                        "in": "query",
                        "required": true
                    }
        ...
        "/api/v1/variablesets/{variableSetName}": {
            "get": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UpdateVariableSetRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "entity.Variable": {
            ...
            "properties": {
                ...
                "type": {
                    "description": "Type is the text type of the variable.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/entity.VariableType"
                        }
                    ]
                },
                "value": {
                ...
                "variableSet": {
                    "description": "VariableSet is the variable set to which the variable belongs.",
                    "type": "string"
                }
            }
        },
        "entity.VariableSet": {
            ...
            "properties": {
                "labels": {
                    "description": "Labels clarifies the scope of the variable set.",
                    "type": "object",
                    "additionalProperties": {
                        "type": "string"
                    }
                ...
                "name": {
                    "description": "Name is the name of the variable set.",
                    "type": "string"
                }
            }
        },
        ...
        "response.PaginatedVariableResponse": {
            "type": "object",
            "properties": {
                "currentPage": {
                    "type": "integer"
        ...
        "response.PaginatedVariableSetResponse": {
            "type": "object",
            "properties": {
                "currentPage": {
                    "type": "integer"
