...
func (g *databaseGenerator) generateLocalPVC(db *database.Database, spec *models.Spec) error {
	...
	return appconfiguration.AppendToSpec(
		models.Kubernetes,
		appconfiguration.KubernetesResourceID(pvc.TypeMeta, pvc.ObjectMeta),
		spec,
		pvc,
	)
}
...
func (g *databaseGenerator) generateLocalDeployment(db *database.Database, spec *models.Spec) error {
	...
	return appconfiguration.AppendToSpec(
		models.Kubernetes,
		appconfiguration.KubernetesResourceID(deployment.TypeMeta, deployment.ObjectMeta),
		spec,
		deployment,
	)
}
...
func (g *databaseGenerator) generateLocalService(db *database.Database, spec *models.Spec) (string, error) {
	...
	return svcName, appconfiguration.AppendToSpec(
		models.Kubernetes,
		appconfiguration.KubernetesResourceID(service.TypeMeta, service.ObjectMeta),
		spec,
		service,
	)
}
