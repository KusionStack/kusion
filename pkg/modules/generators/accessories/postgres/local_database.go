...
var (
	localSecretSuffix  = "-postgres-local-secret"
	localPVCSuffix     = "-postgres-local-pvc"
	localServiceSuffix = "-postgres-local-service"
)
...
func (g *postgresGenerator) generateLocalSecret(spec *apiv1.Intent) (string, error) {
	...
	secret := &v1.Secret{
		...
		ObjectMeta: metav1.ObjectMeta{
			Name:      g.postgres.DatabaseName + localSecretSuffix,
...
func (g *postgresGenerator) generateLocalPVC(db *postgres.PostgreSQL, spec *apiv1.Intent) error {
	...
	pvc := &v1.PersistentVolumeClaim{
		...
		ObjectMeta: metav1.ObjectMeta{
			Name:      g.postgres.DatabaseName + localPVCSuffix,
			Namespace: g.project.Name,
...
func (g *postgresGenerator) generateLocalPodSpec(db *postgres.PostgreSQL) (v1.PodSpec, error) {
	...
	secretName := g.postgres.DatabaseName + localSecretSuffix
	...
	volumes = []v1.Volume{
		{
			...
			VolumeSource: v1.VolumeSource{
				PersistentVolumeClaim: &v1.PersistentVolumeClaimVolumeSource{
					ClaimName: g.postgres.DatabaseName + localPVCSuffix,
				},
			},
		},
	}
...
func (g *postgresGenerator) generateLocalService(db *postgres.PostgreSQL, spec *apiv1.Intent) (string, error) {
	...
	svcName := g.postgres.DatabaseName + localServiceSuffix
